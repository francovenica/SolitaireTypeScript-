const renderSingleCard = function (context: CanvasRenderingContext2D, posx: number, posy: number, card: Card){
    if(card.faceUp)
    {
  ...
  const renderTableau = function(context: CanvasRenderingContext2D, posx: number,
     posy: number, tableau: Card[][]){
  ...
  const renderRecycleIcon = function (context: CanvasRenderingContext2D, posx: number, posy: number){
    const arrowPosX = posx + 30
    const arrowPosY = posy + 50
  
    const renderArrowHead = function (context: CanvasRenderingContext2D,
      x:number,
      y:number,
      offset_x1:number,
      offset_y1:number,
  ...
  const renderCardsLeftInStock = function (context: CanvasRenderingContext2D, posx: number, posy: number){
    context.fillStyle = "white"
    context.font = FONT_STYLE
  ...
  const renderEmptyWaste = function(context:CanvasRenderingContext2D, posx:number, posy: number){
  ...
  const renderFoundation = function (
    ...
    const renderStartButton = function (context:CanvasRenderingContext2D, button: typeof START_BUTTON){
      context.fillStyle = "#555"
    ...
    const renderAll = function (context: CanvasRenderingContext2D, x: number, y: number) {
